...
const LigthBox = ({photo, onClose, clickPrev, clickNext}) => (
	<div>
		<div className="lb-overlay-back"></div>
		<div className="lb-overlay">

			<ImageLoading position={parseInt(photo.data.id)}  shortImgUrl={photo.urls.sImg} largeImgUrl={photo.urls.lImg} />
			<div>
		    <h3>{photo.data.title}</h3>
		    <p>{photo.data.owner}<br/>
